...
This course covers the technologies needed to build responsive websites.  Build projects that consume outside APIs and display JSON data using AJAX, Fetch, Promise, and Async/Await and CORS.  Use CSS media queries and responsive CSS techniques to create projects that display well on desktop and mobile.  
